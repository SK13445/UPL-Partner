...
const DashboardLayout = ({ children, title }) => {
  ...
  const menus = {
    ...
    operational_head: [
      { label: "Dashboard", path: "/admin", icon: FaTachometerAlt }, // Same dashboard as admin
      { label: "Users", path: "/admin/users", icon: FaUsers },
      { label: "Approve Partners", path: "/oh/enquiries", icon: FaList },
    ],
    hr: [
      { label: "Pending Enquiries", path: "/hr", icon: FaList },
      { label: "Add Partner", path: "/hr/add-partner", icon: FaPlusCircle },
    ],
    franchise_partner: [
  ...
  // ✅ Select menu based on logged-in user role
